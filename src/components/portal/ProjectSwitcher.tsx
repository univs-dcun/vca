...
function OrgIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <rect x="1.5" y="1.5" width="5.5" height="5.5" rx="1" stroke="#94a3b8" strokeWidth="1.2"/>
      <rect x="9" y="1.5" width="5.5" height="5.5" rx="1" stroke="#94a3b8" strokeWidth="1.2"/>
      <rect x="1.5" y="9" width="5.5" height="5.5" rx="1" stroke="#94a3b8" strokeWidth="1.2"/>
      <rect x="9" y="9" width="5.5" height="5.5" rx="1" stroke="#94a3b8" strokeWidth="1.2"/>
    </svg>
  );
}
...
function ProjectIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path d="M2 4.5C2 3.67157 2.67157 3 3.5 3H6.5L8 4.5H12.5C13.3284 4.5 14 5.17157 14 6V11.5C14 12.3284 13.3284 13 12.5 13H3.5C2.67157 13 2 12.3284 2 11.5V4.5Z" stroke="#5a3dfb" strokeWidth="1.2"/>
    </svg>
  );
}
...
function StarIcon({ filled }: { filled: boolean }) {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill={filled ? "#f59e0b" : "none"}>
      <path d="M8 1.5L9.85 5.6L14.3 6.15L11 9.25L11.85 13.7L8 11.5L4.15 13.7L5 9.25L1.7 6.15L6.15 5.6L8 1.5Z" stroke={filled ? "#f59e0b" : "#ccd5e1"} strokeWidth="1.1" strokeLinejoin="round"/>
    </svg>
  );
}
...
function CheckIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 14 14" fill="none">
      <path d="M2.5 7.5L5.5 10.5L11.5 3.5" stroke="#5a3dfb" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
    ...
    <>
      <button
        ...
        style={{
          ...
          padding: "6px 8px", borderRadius: "999px", color: "#0e162a",
        }}
      >
        ...
        <span style={{ color: "#94a3b8", display: "flex" }}><ChevronDown /></span>
      </button>
        ...
        >
          <div style={{
            ...
            <div style={{ padding: "18px 20px 14px", display: "flex", alignItems: "center", justifyContent: "space-between", borderBottom: BORDER }}>
              <p style={{ fontSize: "16px", fontWeight: 800, color: "#0e162a" }}>Select a resource</p>
              <button
                onClick={() => { setOpen(false); onNewProject(); }}
                style={{ display: "flex", alignItems: "center", gap: "6px", background: "none", border: "none", cursor: "pointer", color: "#5a3dfb", fontSize: "12px", fontWeight: 700 }}
              >
                <svg width="16" height="16" viewBox="0 0 14 14" fill="none"><path d="M7 2.9V11.1M2.9 7H11.1" stroke="#5a3dfb" strokeWidth="1.4" strokeLinecap="round"/></svg>
                New Project
              </button>
            </div>
            ...
            <div style={{ padding: "14px 20px 0" }}>
              ...
              <div style={{
                ...
                fontSize: "12px", fontWeight: 700, color: "#475469",
              }}>
              ...
              <div style={{ position: "relative", marginBottom: "12px" }}>
                ...
                <input
                  ...
                  style={{
                    ...
                    border: searchFocused ? "1px solid #8c85ff" : BORDER, outline: "none",
                ...
                {TABS.map(t => (
                  <button
                    ...
                    style={{
                      ...
                      color: tab === t.id ? "#5a3dfb" : "#94a3b8",
                      borderBottom: tab === t.id ? "2px solid #5a3dfb" : "2px solid transparent",
                    }}
                  >
                    {t.label}
                  </button>
            ...
            <div style={{ flex: 1, overflowY: "auto" }}>
              ...
              {showOrgRow && (
                <div style={{ display: "grid", gridTemplateColumns: "28px 1.6fr 0.9fr 1.3fr 32px", padding: "8px 20px", gap: "8px", alignItems: "center" }}>
                  <span />
                  <span style={{ display: "flex", alignItems: "center", gap: "8px", fontSize: "12px", fontWeight: 700, color: "#0e162a" }}>
                    <OrgIcon /> {org?.name}
                  </span>
                  <span style={{ fontSize: "12px", color: "#64748a" }}>Organization</span>
                  <span style={{ fontSize: "10px", color: "#94a3b8", fontFamily: "monospace" }}>{org?.id}</span>
                  <span />
                </div>
              )}

              {visibleProjects.length === 0 && !showOrgRow && (
                <p style={{ fontSize: "12px", color: "#94a3b8", padding: "20px", textAlign: "center" }}>
              ...
              {visibleProjects.map(p => {
                ...
                return (
                  ...
                  >
                    <span style={{ display: "flex", color: "#5a3dfb" }}>{isCurrent && <CheckIcon />}</span>
                    <span style={{ display: "flex", alignItems: "center", gap: "8px", fontSize: "12px", fontWeight: 700, color: "#0e162a", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                      <ProjectIcon /> {p.name}
                    </span>
                    <span style={{ fontSize: "12px", color: "#64748a" }}>Project</span>
                    <span style={{ fontSize: "10px", color: "#94a3b8", fontFamily: "monospace", overflow: "hidden", textOverflow: "ellipsis" }}>{p.id}</span>
            ...
            <div style={{ padding: "12px 20px", borderTop: BORDER, display: "flex", justifyContent: "flex-end" }}>
              <button
                ...
                style={{ padding: "9px 16px", borderRadius: "999px", border: BORDER, backgroundColor: "white", color: "#475469", fontSize: "13px", fontWeight: 700, cursor: "pointer" }}
              >
                Cancel
              </button>
            </div>
          </div>
          <style>{`.portal-switcher-row:hover{background-color:#f8fafc}`}</style>
        </div>
      )}
    </>
  );
