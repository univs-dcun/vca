...
export default function ClientLayout() {
  // 데이터 연결(UV-52): 콘솔 역할이면 팀·프로젝트 목록을 Admin API로 채운다 (헤더 현장 전환) — 폴링 없음.
  // 20260909 반입 때 VipSimulation의 `return null` 뒤에 들어가 죽어 있던 호출을 이 자리로 옮겼다.
  usePortalLive({ poll: false });
