...
interface VcaStoreState {
  ...
  renameProject: (projectId: string, name: string) => void | Promise<void>;
  /**
   ...
   */
  removeProject: (projectId: string) => void | Promise<void>;
  ...
  renameTeam: (teamId: string, name: string) => void | Promise<void>;
  ...
  addRosterEntries: (entries: Omit<RosterEntry, "status" | "code" | "issuedAt">[], source: string) => string[] | Promise<string[]>;
