 ...
 */
import type { PortalConnectivityCamerasItemStatus } from './portalConnectivityCamerasItemStatus';

export type PortalConnectivityCamerasItem = {
  cameraId: string;
  /** @nullable */
  code?: string | null;
  name: string;
  /** @nullable */
  zone?: string | null;
  status: PortalConnectivityCamerasItemStatus;
  /** @nullable */
