 ...
 * 명부의 2값 언어 — 화면 확인 문구용
 */
export type AuthCodeLookupResponseDataPermission = typeof AuthCodeLookupResponseDataPermission[keyof typeof AuthCodeLookupResponseDataPermission];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AuthCodeLookupResponseDataPermission = {
  admin: 'admin',
  operator: 'operator',
} as const;
