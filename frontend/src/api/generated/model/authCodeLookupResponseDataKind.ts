 ...
 */
export type AuthCodeLookupResponseDataKind = typeof AuthCodeLookupResponseDataKind[keyof typeof AuthCodeLookupResponseDataKind];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AuthCodeLookupResponseDataKind = {
  roster: 'roster',
  setup: 'setup',
} as const;
