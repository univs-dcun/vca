 ...
 */
import type { EvidencePattern } from './evidencePattern';
import type { EvidenceLocation } from './evidenceLocation';

/**
 * Joint Evidence 집계 요약 (계약 v1.8) — 원본 이벤트 전량이 아닌 백엔드 계산 요약
 */
export interface AssociateEvidence {
  /**
   * 기간 내 페어 동반 감지 총횟수 — 목록의 coCaptures와 동일 값
   * @minimum 1
   */
  totalEvents: number;
  firstSeenAt: string;
