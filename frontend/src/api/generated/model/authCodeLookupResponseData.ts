 ...
 */
import type { AuthCodeLookupResponseDataKind } from './authCodeLookupResponseDataKind';
import type { AuthCodeLookupResponseDataPermission } from './authCodeLookupResponseDataPermission';

export type AuthCodeLookupResponseData = {
  /** roster = 명부 코드(신규 계정) / setup = 기존 계정 셋업 코드 */
  kind: AuthCodeLookupResponseDataKind;
  name: string;
  /** @nullable */
  employeeId?: string | null;
  /** 명부의 2값 언어 — 화면 확인 문구용 */
  permission: AuthCodeLookupResponseDataPermission;
  /** @nullable */
