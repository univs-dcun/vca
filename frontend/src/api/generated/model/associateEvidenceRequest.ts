...
/**
 * Joint Evidence 요청 (계약 v1.8) — 동료 목록 요청과 같은 컨텍스트 + associateId
 */
export interface AssociateEvidenceRequest {
  source: TrackSource;
  /** primary target의 감지 eventId */
  targetId: string;
  /** /targets/associates 응답의 associateId */
  associateId: string;
  /**
   * 집계 시작 (생략 시 최근 7일) — 목록 요청과 같은 값을 보낼 것
   * @nullable
   */
  from?: string | null;
  /**
