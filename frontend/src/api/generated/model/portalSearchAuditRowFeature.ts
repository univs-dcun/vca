...
export type PortalSearchAuditRowFeature = typeof PortalSearchAuditRowFeature[keyof typeof PortalSearchAuditRowFeature];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PortalSearchAuditRowFeature = {
  redmap: 'redmap',
  reid: 'reid',
  track: 'track',
  redface: 'redface',
