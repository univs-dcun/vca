 ...
 */
import type { EvidencePatternPeakPeriodBucket } from './evidencePatternPeakPeriodBucket';

export type EvidencePatternPeakPeriod = {
  /** 사이트 로컬 기준 최다 시간대 — morning 05~12 / afternoon 12~17 / evening 17~21 / night 21~05 */
  bucket: EvidencePatternPeakPeriodBucket;
  /**
   * 전체 동반 감지 중 해당 시간대 비율
   * @minimum 0
   * @maximum 1
   */
  ratio: number;
  /**
   * (v1.10) 해당 시간대의 동반 감지 건수 — 화면이 'Morning · 192' 형태로 표기
   * @minimum 1
   */
  count: number;
};
