 ...
 */
import type { PortalRosterRowPermission } from './portalRosterRowPermission';
import type { PortalRosterRowStatus } from './portalRosterRowStatus';

export interface PortalRosterRow {
  employeeId: string;
  projectId: string;
  name: string;
  /** @nullable */
  ...
  /** @nullable */
  email?: string | null;
  permission: PortalRosterRowPermission;
  /** expired는 저장값이 아니라 issuedAt + 14일로 판정 */
  status: PortalRosterRowStatus;
  /** @nullable */
