...
/**
 * 프론트 rosterImport.ts ImportIssue와 동일 어휘
 * @nullable
 */
export type PortalRosterBulkResultRowsItemReason = typeof PortalRosterBulkResultRowsItemReason[keyof typeof PortalRosterBulkResultRowsItemReason] | null;


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PortalRosterBulkResultRowsItemReason = {
  'missing-employee-id': 'missing-employee-id',
  'missing-name': 'missing-name',
  'duplicate-in-file': 'duplicate-in-file',
  'duplicate-in-roster': 'duplicate-in-roster',
