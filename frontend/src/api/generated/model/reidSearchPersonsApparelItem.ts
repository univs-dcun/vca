...
export type ReidSearchPersonsApparelItem = typeof ReidSearchPersonsApparelItem[keyof typeof ReidSearchPersonsApparelItem];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ReidSearchPersonsApparelItem = {
  trousers: 'trousers',
  shorts: 'shorts',
  skirts: 'skirts',
