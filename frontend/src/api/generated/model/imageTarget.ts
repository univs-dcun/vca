...
import type { ImageTargetMatchedVip } from './imageTargetMatchedVip';
import type { BBox } from './bBox';

/**
 * 이미지에서 검출된 대상 1건. cropUrl은 /api 상대경로 — <img src>로 직접 사용
 */
export interface ImageTarget {
  targetId: string;
  category: DetectionCategory;
  /** 대상 표시명 — 인물 이름 / 차량 번호 / 외형 요약 */
  label: string;
  /** @nullable */
  groupLabel?: string | null;
  /**
   * 등록 인물 매칭 유사도. 미매칭이면 null
   * @minimum 0
   * @maximum 1
   * @nullable
   */
  ...
  /** @nullable */
  matchedVip: ImageTargetMatchedVip;
  bbox: BBox;
  /** 대상 크롭 — GET /images/{imageId}/targets/{targetId}/crop */
  cropUrl: string;
}
