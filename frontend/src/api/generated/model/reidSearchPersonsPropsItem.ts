...
export type ReidSearchPersonsPropsItem = typeof ReidSearchPersonsPropsItem[keyof typeof ReidSearchPersonsPropsItem];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ReidSearchPersonsPropsItem = {
  bag: 'bag',
  hat: 'hat',
  glasses: 'glasses',
} as const;
