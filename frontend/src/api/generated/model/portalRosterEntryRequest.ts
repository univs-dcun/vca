 ...
 */
import type { PortalRosterEntryRequestPermission } from './portalRosterEntryRequestPermission';

export interface PortalRosterEntryRequest {
  /** 명부 전역 유일(대문자 정규화) */
  employeeId: string;
  name: string;
  /** @nullable */
  ...
  permission?: PortalRosterEntryRequestPermission;
}
