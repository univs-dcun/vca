 ...
 */
import type { PortalProjectRequestType } from './portalProjectRequestType';

export interface PortalProjectRequest {
  /** 생성 시 필수 */
  teamId?: string;
  name: string;
  type?: PortalProjectRequestType;
  /** IANA 존, 기본 Asia/Singapore */
  timeZone?: string;
  /** @nullable */
