...
/**
 * 가입 시 계정 권한: admin → 콘솔 admin + 앱 / operator → 콘솔 없음 + 앱
 */
export type PortalRosterEntryRequestPermission = typeof PortalRosterEntryRequestPermission[keyof typeof PortalRosterEntryRequestPermission];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PortalRosterEntryRequestPermission = {
  admin: 'admin',
  operator: 'operator',
} as const;
