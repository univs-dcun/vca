 ...
 */
import type { PortalServerRequestType } from './portalServerRequestType';

export interface PortalServerRequest {
  /** 생성 시 필수 */
  projectId?: string;
  name: string;
  ip: string;
  /**
   * 헬스체크 TCP 포트 — 없으면 ICMP/echo 도달성
   * @nullable
   */
  port?: number | null;
  type: PortalServerRequestType;
  /** @nullable */
