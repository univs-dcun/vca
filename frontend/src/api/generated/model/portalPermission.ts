...
/**
 * 콘솔 역할 — owner: 권한 관리 가능한 유일 역할(활성 0명 불가) / admin: 설치 설정 변경 / auditor: 읽기 전용 / none: 콘솔 없음(앱 전용)
 */
export type PortalPermission = typeof PortalPermission[keyof typeof PortalPermission];
