 ...
 */
import type { AuthResetRequestResponseDataDelivery } from './authResetRequestResponseDataDelivery';

export type AuthResetRequestResponseData = {
  delivery: AuthResetRequestResponseDataDelivery;
  resendLimit: number;
  ttlMinutes: number;
