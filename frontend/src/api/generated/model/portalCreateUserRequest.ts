...
/**
 * email 또는 employeeId 중 하나 필수. 콘솔 역할도 앱 접근도 없는 계정은 400. 임시 비밀번호는 서버 생성 → 응답에 1회만
 */
export interface PortalCreateUserRequest {
  name: string;
  /** @nullable */
  email?: string | null;
  /**
