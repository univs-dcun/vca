 ...
 */
import type { AssociatesResultApplied } from './associatesResultApplied';
import type { TrackedTargetSummary } from './trackedTargetSummary';
import type { Associate } from './associate';

/**
 * RedFace 동료 목록 (계약 v1.8). associates는 coCaptures 내림차순 상위 최대 30명
 */
export interface AssociatesResult {
  /** 집계 실행 ID — 로그 추적·향후 비동기 전환 대비 */
  searchId: string;
  /** 실제 적용된 집계 구간 에코 */
  applied: AssociatesResultApplied;
  target: TrackedTargetSummary;
  /** coCaptures 내림차순, 최대 30명 — 없으면 빈 배열 */
