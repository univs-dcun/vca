 ...
 */
import type { PortalRosterBulkResultRowsItem } from './portalRosterBulkResultRowsItem';

export interface PortalRosterBulkResult {
  added: number;
  rejected: number;
  rows: PortalRosterBulkResultRowsItem[];
}
