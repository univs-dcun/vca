...
/**
 * invited = 코드/초대 받고 비밀번호 미설정(로그인 시 ADM-4017) / suspended = 정지(ADM-4016, 기존 세션 즉시 차단)
 */
export type PortalAccountStatus = typeof PortalAccountStatus[keyof typeof PortalAccountStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PortalAccountStatus = {
  active: 'active',
  invited: 'invited',
  suspended: 'suspended',
} as const;
