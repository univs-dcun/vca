...
export type PortalConnectivityCamerasItemStatus = typeof PortalConnectivityCamerasItemStatus[keyof typeof PortalConnectivityCamerasItemStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PortalConnectivityCamerasItemStatus = {
  online: 'online',
  offline: 'offline',
  error: 'error',
  unknown: 'unknown',
