 ...
 */
import type { BestFrameTarget } from './bestFrameTarget';

/**
 * 베스트 프레임 1장의 대상 목록 (계약 v1.5) — Best Frame Reel과 프레임 bbox 오버레이의 원본
 */
export interface BestFrameTargets {
  frameId: string;
  capturedAt: string;
  targets: BestFrameTarget[];
}
