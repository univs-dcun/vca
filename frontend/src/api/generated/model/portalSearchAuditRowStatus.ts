...
export type PortalSearchAuditRowStatus = typeof PortalSearchAuditRowStatus[keyof typeof PortalSearchAuditRowStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PortalSearchAuditRowStatus = {
  ok: 'ok',
  error: 'error',
} as const;
